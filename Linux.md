...
* grep -n ^l 2.test：行首，搜索l开头的行

  ![image-20260123105323240](images/image-20260123105323240.png)

* grep -n l$ 2.test：行尾，搜索l结尾的行

  ![image-20260123105409545](images/image-20260123105409545.png)

* echo：会在终端显示参数指定的文字，通常会和重定向联合使用

  ![image-20260123110843445](images/image-20260123110843445.png)

* 重定向：将命令执行结果重定向到一个文件，本应该显示在终端的内容 **输出/追加** 到指定文件中，希望保存输出到终端的命令结果可以使用

  * ![image-20260123110916915](images/image-20260123110916915.png)

  * ![image-20260123111316346](images/image-20260123111316346.png)

  * ![image-20260123111002836](images/image-20260123111002836.png)

  * ![image-20260123111042331](images/image-20260123111042331.png)

  * ls -lh > a：原本应该输出在终端的结果，输出到文件a中

    ![image-20260123112523151](images/image-20260123112523151.png)

* 管道**|**：将一个命令的输出通过管道作为另一个命令的输入

  * ls -lah | more：ls -lah执行的结果通过more输出，more分屏显示内容

    ![image-20260123145017901](images/image-20260123145017901.png)

  * ls -lah | grep Do：查找Do开头的行，grep在命令执行结果的基础上查询指定的文本

    ![image-20260123145143748](images/image-20260123145143748.png)

### 远程终端常用命令

* shutdown：关闭/重启系统

  ![image-20260123151609779](images/image-20260123151609779.png)

* ifconfig：查询当前计算机当前的网卡配置信息
